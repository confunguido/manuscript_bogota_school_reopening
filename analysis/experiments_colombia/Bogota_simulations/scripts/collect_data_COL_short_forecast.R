...
simdir_name = sprintf('FRED_%d_school_forecast_asymp_%.2f_fm_%.2f_ksus_%.2f_mov',state_input, asymp_infectivity_in,face_mask_transmission_efficacy_in, kids_susceptibility_in)
