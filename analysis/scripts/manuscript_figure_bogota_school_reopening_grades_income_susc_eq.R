...
jpeg('../figures/manuscript_figure_bogota_school_reopening_grades_income_susc_eq.jpeg', width=6.5, height=4.2, units="in", res = 300)
layout(matrix(1:2,nrow = 2, byrow = T))
par(mar = c(2,2,0,1), oma = c(1,3,2,1))
pplt = par("plt")
...
##ylim = c(0,max(tmp_fred$CF_median[tmp_fred$intervention_id == "OpenUniversities"])*1.2),
